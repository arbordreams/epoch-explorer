...
class InnoFlow(FlowModule):
    def __init__(self, cache_path: str, log_path: Union[str, None, MetaChainLogger] = None, model: str = COMPLETION_MODEL, code_env: DockerEnv = None, web_env: BrowserEnv = None, file_env: RequestsMarkdownBrowser = None):
        ...
        self.idea_agent = AgentModule(get_idea_agent(model=COMPLETION_MODEL, reasoning_effort="high", file_env=file_env, code_env=code_env), self.client, cache_path)
        ...
        self.code_survey_agent = AgentModule(get_code_survey_agent(model=CHEEP_MODEL, reasoning_effort="low", file_env=file_env, code_env=code_env), self.client, cache_path)
