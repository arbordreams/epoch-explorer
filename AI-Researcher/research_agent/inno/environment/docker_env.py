...
import subprocess
from research_agent.constant import BASE_IMAGES, AI_USER, GITHUB_AI_TOKEN, GPUS
import time
import socket
import json
...
class DockerEnv:
    ...
    def init_container(self):
        ...
        platform_cmd = ["--platform", platform] if platform else []
        docker_command = [
            "docker", "run", "-d"] + platform_cmd + ["--userns=host",] + gpu_cmd + ["--name", self.container_name, 
